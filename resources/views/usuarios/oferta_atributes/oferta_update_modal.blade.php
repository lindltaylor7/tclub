<div class="modal fade" id="Category_update{{$oferta->id}}" tabindex="-1" role="dialog" aria-labelledby="signup_modal_label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('category.update',$oferta->id)}}" id="signup-form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("put")
                    <div class="form-group">
                        <label for="title" class="form-label">Nombre de Rubro</label>
                        <input type="text" class="form-control" id="atbdp-contact-name" name="name" placeholder="Nombre de rubro" required="" value="{{$oferta->name}}">
                    </div>
                    <div class="form-group">
