<section class="dashboard-wrapper section-bg p-bottom-70">
                ...
                <div class="col-lg-12">
                    <div class="dashboard-nav-area">
                        ...
                        <div class="nav_button">
                            <a href="" class="btn btn-xs btn-gradient btn-gradient-two" data-toggle="modal" data-target="#Registerb_modal"><span class="la la-plus">Agregar una empresa</a>
    ...
    <div class="tab-content p-top-100" id="dashboard-tabs-content">
        @include('usuario.user_business')
        @include('usuario.user_profile')
        @include('usuario.user_activities')
    </div>
</section>
@include('empresa.empresa_register_modal')